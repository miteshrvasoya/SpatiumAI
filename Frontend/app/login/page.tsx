      ...
      <main className="flex min-h-screen items-center justify-center px-5 pt-20 pb-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-[var(--text-secondary)]">Sign in to your SpatiumAI account</p>
          </div>
          ...
          <div className="rounded-2xl border border-[var(--bg-border)] bg-[var(--bg-surface)] p-7">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    placeholder="••••••••"
                    className="w-full rounded-xl border border-[var(--bg-border)] bg-[var(--bg-elevated)] px-3.5 py-2.5 pr-10 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] transition-colors focus:border-[var(--accent-primary)] focus:outline-none focus:ring-1 focus:ring-[var(--accent-primary)]/30"
                  />
                  <button
                    type="button"
            ...
            <div className="my-5 flex items-center gap-3">
              ...
              <span className="font-mono text-[10px] text-[var(--text-tertiary)]">OR</span>
              <div className="flex-1 h-px bg-[var(--bg-border)]" />
            </div>

            <button className="w-full flex items-center justify-center gap-2.5 rounded-xl border border-[var(--bg-border-hover)] bg-[var(--bg-elevated)] px-6 py-2.5 text-sm font-medium text-[var(--text-primary)] transition-all hover:border-[var(--accent-primary)]/40 hover:bg-[var(--bg-card)]">
